...
class WidgetStateTest {
    ...
    private fun rawEn(
        ...
        val today = mapOf(
            "Fajr" to epoch(2026, 4, 13, 5, 0),
            "Sunrise" to epoch(2026, 4, 13, 6, 15),
            "Dhuhr" to epoch(2026, 4, 13, 12, 10),
            "Asr" to epoch(2026, 4, 13, 15, 40),
            "Maghrib" to epoch(2026, 4, 13, 18, 20),
            "Isha" to epoch(2026, 4, 13, 19, 45),
        )
        return RawSchedule(
            today = today,
    ...
    private fun jamaatEn() = mapOf(
        "Fajr" to epoch(2026, 4, 13, 5, 20),
        "Dhuhr" to epoch(2026, 4, 13, 12, 25),
        "Asr" to epoch(2026, 4, 13, 15, 55),
        "Maghrib" to epoch(2026, 4, 13, 18, 33),
        "Isha" to epoch(2026, 4, 13, 20, 0),
    )
    ...
    fun afterMidnight_beforeFajr_keepsIshaOvernightOverState() {
        val today = mapOf(
            "Fajr" to epoch(2026, 4, 14, 5, 0),
            "Sunrise" to epoch(2026, 4, 14, 6, 15),
            "Dhuhr" to epoch(2026, 4, 14, 12, 10),
            "Asr" to epoch(2026, 4, 14, 15, 40),
            "Maghrib" to epoch(2026, 4, 14, 18, 20),
            "Isha" to epoch(2026, 4, 14, 19, 45),
        )
        val jamaat = mapOf(
            "Fajr" to epoch(2026, 4, 14, 5, 20),
            "Dhuhr" to epoch(2026, 4, 14, 12, 25),
            "Asr" to epoch(2026, 4, 14, 15, 55),
            "Maghrib" to epoch(2026, 4, 14, 18, 33),
            "Isha" to epoch(2026, 4, 14, 20, 0),
        )
        val raw = RawSchedule(
            today = today,
            fajrTomorrow = 0L,

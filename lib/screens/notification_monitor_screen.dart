...
import 'home_screen.dart'; // Import to access calculation methods
...
class _NotificationMonitorScreenState extends State<NotificationMonitorScreen> {
  ...
  Map<String, DateTime?> _notificationTimes = {};
  Map<String, DateTime?> _jamaatNotificationTimes = {};
  ...
  void _calculateNotificationTimes() {
    ...
    _notificationTimes = _notificationService.calculatePrayerNotificationTimes(times);
  }
  ...
  Future<void> _loadJamaatNotificationTimes() async {
    ...
    try {
      ...
      if (times != null) {
        ...
        // Calculate jamaat notification times (15 minutes before jamaat)
  ...
  void _addFallbackJamaatTimes(DateTime today) {
    ...
    for (final entry in fallbackTimes.entries) {
      ...
      final notifyTime = jamaatTime.subtract(const Duration(minutes: 15));
